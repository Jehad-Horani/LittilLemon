...
const initialItems = {
    ...
    salads: [
        ...
        { nameAr: "سلطة ", nameEn: "Salad ", price: "3.50 JOD" },
    ],
    ...
    milkshake: [
        ...
        { nameAr: "ميلك شيك ", nameEn: "Milkshake ", price: "3.50 JOD" },
    ...
    cocktail: [
        {
            nameAr: "كوكتيل  (مكس فواكة، آيس كريم)",
            nameEn: "Cocktail  (Mix Fruit, Scoop of Ice Cream)",
            price: "3.50 JOD",
        },
        {
    ...
    icecream: [
        ...
        { nameAr: "سبيشال ", nameEn: "Special ", price: "3.50 JOD", },
    ],
    shisha: [
        { nameAr: " ارجيلة خلطة ", nameEn: "Shisha Mix ", price: "4.00 JOD" },
    ...
    return (
        <section className={styles.menuSection}>
            <div className={styles.menuContainer}>
                <h1 className={styles.menuTitle}>قائمة الطعام | Menu</h1>

                <div className="px-4">
                    <h1 className={styles.menuSearchLabel}>:ابحث عن اي صنف تريده</h1>
                    ...
                    {MENU_SECTIONS.map(({ id, title }) => {
                        const sectionMatchesSearch = title.toLowerCase().includes(search.toLowerCase());
                        ...
                        return (
                            <motion.div key={id} data-aos="fade-up" className="mb-6">
